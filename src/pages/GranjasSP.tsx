...
const GranjasSP: React.FC = () => {
  ...
  return (
    <div className="container mx-auto p-4">
      <h1 className="text-3xl font-bold mb-6 text-[#00693c]">Granjas SP Producción</h1>
      <div className="mb-6">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
          ...
          <ControlButtons
            onStartAll={() => {
              setConfirmMessage("¿Estás seguro de que quieres iniciar todos los procesos?");
          ...
          {paginatedServices.map((service) => (
            <div key={service.id} className="flex flex-col p-4 border border-gray-200 rounded-md shadow-sm bg-white">
              ...
              <div className="mt-auto flex items-center justify-between">
                <button
                  onClick={() =>
                    handleToggleServiceStatus(service.id, service.status === "Activo" ? "stop" : "start")
                  }
